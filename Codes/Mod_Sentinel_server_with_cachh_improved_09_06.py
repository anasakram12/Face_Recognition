...
class OptimizedFaceRecognitionServer:
    def __init__(self):
        ...
        self.num_worker_threads = min(16, self.num_cpu_cores)
        ...
        self.recognition_queue = queue.Queue(maxsize=1000)
        self.batch_request_queue = queue.Queue(maxsize=100)
        ...
        self.http_pool = ThreadPoolExecutor(max_workers=4, thread_name_prefix="HTTP")
    ...
    def create_match_result(self, identity, similarity, input_filename, prefix, camera_id, request_id, query_embedding):
        ...
        try:
            ...
            result = {
                ...
                "identity": identity.split('@')[0],  # Clean identity name
                "camera_id": camera_id,
                "request_id": request_id,
