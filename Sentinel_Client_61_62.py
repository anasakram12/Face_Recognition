...
from PySide6.QtWidgets import (QLabel, QVBoxLayout, QHBoxLayout, QFileDialog, 
                             ...
                             QInputDialog, QHeaderView, QWidget)
from PySide6.QtGui import QAction
from PySide6.QtCore import Qt, Signal, QObject, QTimer, QDateTime, QMimeData, QUrl
...
# Setup logging
LOG_FILE = 'face_recognition_client_61_62.log'
logging.basicConfig(
    filename=LOG_FILE,
    level=logging.INFO,
...
class FaceRecognitionClient(QtWidgets.QWidget):
    def __init__(self):
        super().__init__()
        self.config_file = 'Sources/client_config_61_62.ini'
    ...
    def process_new_image(self, file_path):
        try:
            ...
            # Check for camera number - fixed the typo in 'camera61'
            camera_number = None
...
class FolderWatchHandler(QObject, FileSystemEventHandler):
    image_created_signal = Signal(str)
